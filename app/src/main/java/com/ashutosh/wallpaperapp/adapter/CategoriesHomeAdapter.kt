...
import com.ashutosh.wallpaperapp.databinding.HomeCategoryItemLayoutBinding
...
class CategoriesHomeAdapter(val context: Context, private val list: List<CategoryModel>) :
    ...
    class ItemViewHolder(val binding: HomeCategoryItemLayoutBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        return ItemViewHolder(HomeCategoryItemLayoutBinding.inflate(LayoutInflater.from(context)))
