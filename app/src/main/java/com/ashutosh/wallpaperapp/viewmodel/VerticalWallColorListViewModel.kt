...
@HiltViewModel
class VerticalWallColorListViewModel @Inject constructor(private val wallpapersRepository: WallpapersRepository) : ViewModel() {
    ...
    fun getWallpaper(orderBy:String? = null, category: String?=null, color: String?=null) {
//        if (_list.isNotEmpty()) return
        _liveIsLoading.value = true

        viewModelScope.launch(Dispatchers.IO) {
            val response = wallpapersRepository.getWallpapers(page = page, orderBy = orderBy, color = color)
